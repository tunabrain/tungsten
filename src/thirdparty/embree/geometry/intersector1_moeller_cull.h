...
#ifndef __EMBREE_INTERSECTOR1_MOELLER_CULL_H__
#define __EMBREE_INTERSECTOR1_MOELLER_CULL_H__

#include "../common/ray.h"

namespace embree
{
  /*! Implements a modified version of the Moeller Trumbore intersector with backface culling. */
  struct Intersector1MoellerTrumboreCull
  {
    /*! Name of intersector */
