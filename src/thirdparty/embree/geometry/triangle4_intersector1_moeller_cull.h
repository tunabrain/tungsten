...
#ifndef __EMBREE_ACCEL_TRIANGLE4_INTERSECTOR1_MOELLER_CULL_H__
#define __EMBREE_ACCEL_TRIANGLE4_INTERSECTOR1_MOELLER_CULL_H__
...
namespace embree
{
  /*! Intersector for a single ray with 4 triangles with backface culling.
   *  This intersector implements a modified version of the Moeller Trumbore
  ...
  struct Triangle4Intersector1MoellerTrumboreCull
  {
