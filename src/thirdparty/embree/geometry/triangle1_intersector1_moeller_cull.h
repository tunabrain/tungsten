...
#ifndef __EMBREE_ACCEL_TRIANGLE1_INTERSECTOR1_MOELLER_CULL_H__
#define __EMBREE_ACCEL_TRIANGLE1_INTERSECTOR1_MOELLER_CULL_H__
...
namespace embree
{
   ...
   *  triangles with backface culling. This intersector implements a
   *  modified version of the Moeller Trumbore intersector from the paper
   *  "Fast, Minimum Storage Ray-Triangle Intersection". In contrast to the
   *  paper we precalculate some factors and factor the calculations
   ...
   *  Search". */
  struct Triangle1Intersector1MoellerTrumboreCull
  {
    typedef Triangle1 Triangle;

    /*! Name of intersector */
    static const char* name() { return "moeller_cull"; }
