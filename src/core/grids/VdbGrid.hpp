...
public:
    ...
    float densityIntegral(Vec3f p, Vec3f w, float t0, float t1) const override;
    Vec2f inverseOpticalDepth(Vec3f p, Vec3f w, float t0, float t1, float sigmaT, float xi) const override;
};
